...
import watchkeep from './images/Icons/watch.png';
            ...
            <Col xs={12} lg={6}>
              <div className="overview-text">
                ...
                <p className="font-weight-light">
                  Call or email us and we will assist you with any questions you
                  may have regarding YMP. Training for usage of the program can
                  also be arranged via Skype.
                </p>
                <h5>Free Updates and Daily Backup</h5>
                <p className="font-weight-light">
                  Updates are included to improve performance, stability and
                  security, as well additional new features for your program.
                  Daily backup feature to ensure your data is safe and secure.
                </p>
                <h5>ISM Package</h5>
                <p className="font-weight-light">
                  An ISM package with forms, checklists and scheduled checks can
                  be provided with your program.
                </p>
                <h5>Setup of Engineering Equipment and Jobs</h5>
                <p className="font-weight-light">
                  By arrangement we can set up the basic engineering equipment
                  with the scheduled maintenance jobs and appertaining manuals.
                </p>
                <h5>Basic equipment includes:</h5>
                <p className="font-weight-light">¤ Main Engines ¤ Generators</p>
              </div>
            </Col>
          </Row>
        </Container>
